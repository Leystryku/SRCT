...
{
public:
	virtual int  CommandCompletionCallback( const char *pPartial ) = 0;
};
...
public:
	...
	virtual int AutoCompleteSuggest( void );
...
class CConCommandMemberAccessor : public ConCommand, public ICommandCallback, public ICommandCompletionCallback
{
	...
	typedef int  ( T::*FnMemberCommandCompletionCallback_t )( const char *pPartial );
